...
multi sub format-M(\width,\data) {
    my \terms = width > 4
        ?? data.calendar.months.format.narrow           # 5+
        !! width == 4
            ?? data.calendar.months.format.wide         # 4
            !! data.calendar.months.format.abbreviated; # 3
